...
*Last updated: 2026-05-25, base SHA `d17218d` (debug-mode test-suite timing + fem_eig_003 SIGKILL gotchas documented). Update this file whenever a decision is made twice or a gotcha bites twice.*
