...
*Last updated: 2026-05-25, base SHA `77cd0d9` (Phase 4.fem.eig.3.5.6 shipped — Lee-Mittra absorbing-mode wave-port escape-hatch; fem-eig-006 status + Phase 4.fem.eig.3.5.7 queued). Update this file whenever a decision is made twice or a gotcha bites twice.*
